<template>
    ...
    <div>
        <h5 class="text-center titulo"><b>ADMINISTRADORES</b></h5>
        <hr class="w-100" />
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="checkbox" class="letra" id="emailAdmitidoUsuarioAdministrador"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control letra" id="descripcionUsuarioAdministrador"
                                v-model="descripcionUsuarioAdministrador"></textarea>
                        </div>
                        <div class="mb-3">
