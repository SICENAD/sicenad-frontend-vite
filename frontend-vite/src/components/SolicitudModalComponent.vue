<template>
    <!-- Llamada al modal -->
    <a data-bs-toggle="modal" :data-bs-target="'#' + idModal" v-if="isEditable"><v-icon name="fa-edit"
            scale="1.5" /></a>
    <a data-bs-toggle="modal" :data-bs-target="'#' + idModal" v-if="!isEditable"><v-icon name="fa-eye"
            scale="1.5" /></a>
    <!-- Modal -->
    <div class="modal fade" :id="idModal" tabindex="-1" aria-labelledby="modal-editar-solicitud-Label"
        aria-hidden="true">
        <div class="modal-dialog modal-xxl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modal-editar-solicitud-Label">
                        {{ $t('solicitudes.editarSolicitud') }}{{ props.nombre }}
                    </h1>
                        ...
                        <fieldset :disabled="!isEditable">
                            ...
                            <div class="row py-2 justify-content-between">
                                <div class="col-lg-2 col-md-12">
                                    ...
                                    <label class="form-control">{{ props.content.unidadUsuaria }}</label>
                                </div>
                                <div class="col-lg-2 col-md-12">
                                ...
                                <div class="col-lg-2 col-md-12">
                                    <label for="validationServer02">Fecha Solicitud: <sup
                                            class="text-danger"></sup></label>
                                    <input type="date" class="form-control" v-model="fechaSolicitud"
                                        placeholder="dd-MM-yyyy" required name="fechaSol" readonly />
                                </div>
                                <div class="col-lg-2 col-md-12">
                            ...
                            <div class="row py-2 mt-2 justify-content-between">
                                <div class="col-lg-4 col-md-12">
                                    ...
                                    <label class="form-control">{{ props.recurso }}</label>
                                </div>
                                <div class="col-lg-2 col-md-12">
                                ...
                                <div class="col-lg-2 col-md-12">
                                    <label for="validationServer02">Fecha-Hora Fin: <sup
                                            class="text-danger"></sup></label>
                            ...
                            <div class="row py-2 mt-2 justify-content-center me-3">
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <textarea class="form-control" name="observacionesCenad"
                                        v-model="observacionesCenad" placeholder="Observaciones del CENAD/CMT">
                                </textarea>
                                </div>
                            </div>
...
const pocEjercicio = ref(props.content.pocEjercicio)
const tlfnRedactor = ref(props.content.tlfnRedactor)
const fechaSolicitud = ref()
const fechaHoraInicioRecurso = ref(props.content.fechaHoraInicioRecurso)
const fechaHoraFinRecurso = ref(props.content.fechaHoraFinRecurso)
const estado = ref(props.content.estado)
const observacionesCenad = ref(props.content.observacionesCenad)
const fechaFinDocumentacion = ref(props.content.fechaFinDocumentacion)
const isAdminEsteCenad = ref(false)
const isGestorEsteCenad = ref(false)
const idCenad = computed(() => route.params.id)
const idModal = 'modal-categoria-' + props.content.idString
const idModalEliminar = 'modal-categoria-eliminar' + props.content.idString
...
onMounted(async () => {
    ...
    // Normalizar fechas
    fechaSolicitud.value = formatDate(props.content.fechaSolicitud) // "YYYY-MM-DD"
    fechaHoraInicioRecurso.value = formatDateTime(props.content.fechaHoraInicioRecurso) // "YYYY-MM-DDTHH:mm"
    fechaHoraFinRecurso.value = formatDateTime(props.content.fechaHoraFinRecurso)       // "YYYY-MM-DDTHH:mm"
    fechaFinDocumentacion.value = formatDate(props.content.fechaFinDocumentacion)       // "YYYY-MM-DD"
})
const editarSolicitud = async () => {
    await service.editarSolicitud(
        observaciones.value, props.content.unidadUsuaria, jefeUnidadUsuaria.value, pocEjercicio.value, tlfnRedactor.value, fechaHoraInicioRecurso.value, fechaHoraFinRecurso.value, estado.value, idCenad.value, props.content.idString, observacionesCenad.value, fechaFinDocumentacion.value
    );
    emits('emiteModal');
}
const borrarSolicitud = async () => {
    await service.deleteSolicitud(idCenad.value, props.content.idString)
    emits('emiteModal')
}
