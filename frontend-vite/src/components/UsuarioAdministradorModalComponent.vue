        ...
        <div class="modal-body">
          <form>
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="usernameUsuarioAdministrador" aria-describedby="username"
                v-model="username" />
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control" id="emailUsuarioAdministrador" aria-describedby="emailHelp"
                v-model="email" />
            ...
            <div class="mb-3">
              ...
              <input type="checkbox" class="letra ms-2" id="emailAdmitidoUsuarioAdministrador"
                v-model="emailAdmitido" />
            </div>
            <div class="mb-3">
              <label class="titulo"><b>DESCRIPCIÓN<sup class="text-danger">*</sup></b></label>
              <textarea class="form-control letra" id="descripcionUsuarioAdministrador"
